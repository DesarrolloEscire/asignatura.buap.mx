...
Route::post('/registrarse/crear', App\Http\Controllers\Users\RegisterAccountController::class)->name('register.store');
...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::get('/asignaturas-virtuales', App\Http\Livewire\VirtualSubjects::class)->name('virtual-subjects');
