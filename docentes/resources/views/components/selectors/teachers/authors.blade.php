<div x-data="teacherData($wire)">
    ...
    <div class="kt-table-responsive mb-3" style="max-height: 400px; overflow-y: scroll">
        <table class="table">
            ...
            <tbody>
                <template x-for="teacher in teachersSelected" :key="teacher.id">
                    <tr>
                        <td>
                            <input type="checkbox" name="teacher_ids[]" :value="teacher.id" checked
    ...
    <script>
        function teacherData($wire) {
            return {
                teachersSelected: @json($teachersSelected),
                ...
                async onSelectTeacher(event, teacherToPush) {
                    ...
                    teacherAlreadySelected = _.find(this.teachersSelected, function(teacher) {
                    ...
                    this.teachersSelected.push(teacherToPush)
                },

                async onUnselectTeacher(teacherToRemove) {

                    this.teachersSelected = _.filter(this.teachersSelected, function(teacher) {
