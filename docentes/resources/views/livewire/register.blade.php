<div class="card-body" x-data="data($wire)" x-init="init()" wire:ignore>
        ...
        <div class="form-row">
            <div class="col-md-12">
                <div class="position-relative form-group">
                    <input type="text" id="identifier" name="identifier" class="form-control" placeholder="Identificador" required autofocus x-on:keyup="onSearchTeacher($event.target.value)">
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="col-12 mb-3">
                                ...
                                <input :value="teacher.identifier" name="identifier" type="text" class="form-control" placeholder="Tu id de docente" required maxlength="190"/>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="" class="text-muted text-uppercase">Nombre</label>
                                <input :value="teacher.name" name="name" type="text" class="form-control" placeholder="Tu nombre completo" required maxlength="190"/>
                            </div>
                            <div class="col-12">
                                <label for="" class="text-muted text-uppercase">Correo electrónico</label>
                                <div class="input-group mb-3">
                                    <input :value="teacher.email" name="email" pattern="^[^@]+$"  type="text" class="form-control" placeholder="Correo" aria-label="correo" required maxlength="170" >
                            ...
                            <template x-if="!teacherExists">
                                <div class="col-12 clearfix modal-footer">
                                    <br>
                                    <hr>
                                    <button class="btn btn-success btn-sm btn-shadow float-right" form="requestUserForm">
                                        Solicitar registro
                                    </button>
                                </div>
                            </template>
    ...
    <script>
        function data() {
            return {
                teacher: {identifier:null,name:null,email:null},
                ...
                async onSearchTeacher(identifier) {
                    ...
                    if (response != null) {
                        ...
                        this.teacher = {identifier:null,name:null,email:null};
