<div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <a href="{{route('plannings.index')}}" class="text-info float-right">
        ...
        <div class="col-12 mb-2">
            <div class="col-12">
                <div class="kt-card">
                    <div class="card-body">
                        <x-shared.empty-box text="Ninguna planeación didáctica creada. dale <a href='{{route('plannings.index')}}'>click aquí</a> para búscar una asignatura y crear tu planeación didáctica." />
                    </div>
                </div>
            </div>
        </div>
